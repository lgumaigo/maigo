...
-->
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="img/groundbreaking.jpg" class="img-fluid w-100" alt="Image">
     ...
     Services End -->
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                <h2 class="averta-extrabold">Ground Breaking Ceremony of the New Municipal Hall

                </h2>
                <i class="fa fa-calendar"> <span class="averta-regular"> DATE :May 17, 2023</span></i><br>
                <i class="fa fa-user"> <span class="averta-regular"> Author • Municipality of Maigo</span> </i><br><br>

                Ground Breaking Ceremony of the New Municipal Hall, The New Legislative of Maigo and The Coast Guard
                Station...
                Mark your Calendar for History of Maigo...
                Padayon Asenso Maigo...
                Congratulations to Municipal Mayor Rafael "Paeng" Rizalda and Vice Mayor Lanto Mutia and To all the
                Department Heads.
            </div>
            <!--<div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
