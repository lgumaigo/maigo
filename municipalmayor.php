...
<script>
    ...
    setInterval(updateClock, 1000);
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">The Municipal Mayor</h1>
          ...
          <div class="col-md-3 col-for-side-nav">
            <div class="fixed-sidebar">
              <ul class="col-12 col-lg-auto pages-side-nav-ul">
                <li><a href="http://localhost/maigowebsite/municipalmayor.php" class="px-2 text-dark averta-regular active-side-nav">The Municipality Mayor</a></li>
    ...
    <img class="img-fluid rounded w-50" src="img/sb0.jpg" alt="">
    <div class="about-experience bg-secondary rounded text-center p-0 mt-3">
        <h1 class="display-1 mb-0 text-white">22</h1>
...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <div class="col-lg-6">
            <div class="p-4">
                <h4 class="section-title text-start text-primary mb-4">Maigo Municipal Mayor Profile</h4>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="feature-box text-center p-4 bg-light rounded">
                            ...
                            <p>As a husband and father, he leads by example, embodying the values of empathy, humility, and dedication to service.<br><br><br></p>
                        </div>
                    </div>
                </div>
            </div>
