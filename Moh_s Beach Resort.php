    ...
    <body>
            ...
            <div class="row gx-0 align-items-center" style="height: 45px;">
                <div class="col-lg-8 text-center text-lg-start mb-lg-0">
                    <div class="d-flex flex-wrap">
                        <a href="https://www.google.com/maps/place/Maigo,+Lanao+del+Norte/@8.0997915,123.8947862,12z/data=!3m1!4b1!4m6!3m5!1s0x3255af4c749116cb:0xa0be461bcd0cd87a!8m2!3d8.1144279!4d123.986149!16zL20vMDZyYjB4?entry=ttu"
                            class="text-light me-4"><i class="fas fa-map-marker-alt text-primary me-2"></i>Maigo, Lanao
                            del Norte</a>
                        <a href="#" class="text-light me-4"><i
                                class="fas fa-phone-alt text-primary me-2"></i>09999999999</a>
                        <a href="#" class="text-light me-0"><i
                                class="fas fa-envelope text-primary me-2"></i>lgumaigoldn@gmail.com</a>
                    </div>
                </div>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Discover The Gems of <FONT
                        COLOR=aqua>M</FONT>
        ...
        <div class="container-fluid team py-5">
            <div class="container py-5">
                <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-3 mb-4">Moh's Beach Resort</h1>
                    <p>Welcome to Moh's Beach Resort is a nice place to relax and smell the fresh sea air , Free PLDT
                        wifi internet to all customers.Affordable Clean and No entrance or corkage fees for reservations
                        can call their tel. No. (063) 2243381 located at purok 3 labuay maigo lanao del norte ( unahan
                        sa palengke sa poblacion maigo ldn. )
                ...
                <div class="container-fluid team py-5">
                    <div class="container py-5">
                        <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="sub-style">
                                <h4 class="sub-title px-3 mb-0">OTHER RELATED</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row g-4 justify-content-center">
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/MOHCANOY.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1"
                                        href="https://www.facebook.com/profile.php?id=100054546395930"><i
                                            class="fab fa-facebook-f"></i></a>
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                                <h5><a href="Kutitap BEACH Resort - sonny&reneecanoy.php">
                                        <FONT COLOR="black"> Kutitap BEACH Resort - sonny&reneecanoy</FONT>
                                </h5></a><br><br><br><br><br><br><br><br><br>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/moh.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1"
                                        href="https://www.facebook.com/mohsbeachresort"><i
                                            class="fab fa-facebook-f"></i></a>
                                    <!-- <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-instagram"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-linkedin-in"></i></a>-->
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                                <h5><a href="Moh_s Beach Resort.php">
                                        <FONT COLOR="black"> Moh's Beach Resort</FONT>
                                </h5></a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/calao.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1"
                                        href="https://www.facebook.com/pages/Calao-Beach-Resortlanao-Del-Norte/162104013950544"><i
                                            class="fab fa-facebook-f"></i></a>
                                    <!--<a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-instagram"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-linkedin-in"></i></a>-->
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                                <h5><a href="Calao Beach Resort.php">
                                        <FONT COLOR="black">Calao Beach Resort</FONT>
                                </h5></a><br><br><br><br><br><br><br>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/granaderos.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                                <h5><a href="Granaderos Beach Resort.php">
                                        <FONT COLOR="black">Granaderos Beach Resort</FONT>
                                </h5></a><br><br><br><br>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-white"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Copyright
                                2024</a>, Municipality of Maigo</span>
                    </div>
