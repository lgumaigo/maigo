...
-->
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="img/CS.jpg" class="img-fluid w-100" alt="Image">
     ...
     Services End -->
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                <h2 class="averta-extrabold">𝙁𝙚𝙗𝙧𝙪𝙖𝙧𝙮 𝙞𝙨 𝘾𝙞𝙫𝙞𝙡 𝙍𝙚𝙜𝙞𝙨𝙩𝙧𝙖𝙩𝙞𝙤𝙣 𝙈𝙤𝙣𝙩𝙝!
                </h2>
                <i class="fa fa-calendar"> <span class="averta-regular"> DATE :Feb 01, 2024</span></i><br>
                <i class="fa fa-user"> <span class="averta-regular"> Author • Municipality of Maigo</span> </i><br><br>

                𝐅𝐫𝐞𝐞 𝐈𝐬𝐬𝐮𝐚𝐧𝐜𝐞 𝐨𝐟 𝐂𝐞𝐫𝐭𝐢𝐟𝐢𝐞𝐝 𝐏𝐡𝐨𝐭𝐨𝐜𝐨𝐩𝐲 𝐚𝐧𝐝 𝐓𝐫𝐚𝐧𝐬𝐜𝐫𝐢𝐩𝐭 𝐨𝐟
                𝐂𝐢𝐯𝐢𝐥 𝐃𝐨𝐜𝐮𝐦𝐞𝐧𝐭𝐬 𝐚𝐧𝐝 𝐌𝐨𝐛𝐢𝐥𝐞 𝐑𝐞𝐠𝐢𝐬𝐭𝐫𝐚𝐭𝐢𝐨𝐧 (𝐁𝐢𝐫𝐭𝐡)<br>
                February 1-2, 2024<br>
                LGU Maigo - Municipal Registrar's Office, 8:00 am - 5:00 pm<br>
                Municipal Hall Maigo, 10:00 am - 4:00 pm
            </div>
            <!--<div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
