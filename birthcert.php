    ...
    setInterval(updateClock, 1000);
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                            <a href="http://localhost/maigo/NEWS.php" class="dropdown-item">News</a>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Application for Birth
                    Certificate</h1>
                    <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <!--  <li class="breadcrumb-item"><a href="#">Pages</a></li>-->
                        <li class="breadcrumb-item active text-primary">Birth Certificate</li>
                    </ol>
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-img pb-5 ps-5">
                            <img src="img/birthcert.jpg" class="img-fluid rounded w-100" style="object-fit: cover;"
                                alt="Image">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <h4 class="sub-title pe-3 mb-0">Application for Birth Certificate</h4>
                            <h1 class="display-3 mb-4">Requirements</h1>
                            <p style="text-align: justify; text-indent: 0px; color:black"><strong>Timely
                                    Registration:</strong><br><br> (Within 1-30 days after birth)<br>
                                1. Duly accomplished Certificate of Live Birth, MF-102, in 4 copies<br>
                                2. Duly accomplished Muslim/IP Attachment - MF-102 for Muslim/Indigenous Peoples, in 3
                                copies<br>
                                3. If legitimate child, marriage contract of parents<br>
                                4. If illegitimate child, Duly accomplished Affidavit of Acknowledgement/ Paternity
                                executed by the father and mother (personal appearance) at the back of the COLB, for
                                illegitimate child and Affidavit to use Surname of the father (AUSF)<br><br>
                                <strong>Delayed Registration: </strong> <br><br>

                                (Beyond 30 days after birth)<br>
                                1. Duly accomplished Certificate of Live Birth (COLB) MF-102, in 4 copies<br>
                                2. Duly accomplished Muslim/IP attachment MF-102 for Muslim/Indigenous Peoples, in 3
                                copies<br>
                                3. NSO Negative Certificate<br>
                                4. Barangay Captain Certification, if born at home<br>
                                5. Duly accomplished Affidavit of Acknowledgement/ Paternity executed by the father and
                                mother (personal appearance) at the back of the COLB, for illegitimate child<br>
                                6. Duly accomplished Affidavit of Delayed Registration executed by the informant at the
                                back of the COLB<br>
                                7. Community Tax Cert. No., date, place of issue<br>
                                8. Approval of Indorsement to City Prosecutor’s Office<br>
                                9. Posting period of 10 days<br>
                                10. Sworn Affidavit of 2 disinterested persons attesting to the facts and circumstances
                                of birth<br>
                                11. Any 2 documents (public or private) showing the facts and circumstances of birth<br>
                                12. Affidavit to Use the Surname of the Father (AUSF), if illegitimate child
                            </p>
                            <!--      <div class="mb-4">
