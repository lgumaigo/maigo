...
-->
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="img/msatparade.jpg" class="img-fluid w-100" alt="Image">
     ...
     Services End -->
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                <h2 class="averta-extrabold">MSU-MSAT Joins the 65th Araw ng Maigo Celebration
                ...
                𝐋𝐎𝐎𝐊: 𝐌𝐒𝐔-𝐌𝐒𝐀𝐓 𝐉𝐨𝐢𝐧𝐬 𝐭𝐡𝐞 𝟔𝟓𝐭𝐡 𝐀𝐫𝐚𝐰 𝐧𝐠 𝐌𝐚𝐢𝐠𝐨 𝐂𝐞𝐥𝐞𝐛𝐫𝐚𝐭𝐢𝐨𝐧
                Under the direction of 𝐂𝐚𝐦𝐩𝐮𝐬 𝐇𝐞𝐚𝐝 𝐀𝐭𝐭𝐲. 𝐉𝐚𝐦𝐚𝐥𝐨𝐝𝐞𝐧 𝐀. 𝐁𝐚𝐬𝐚𝐫, MSU-MSAT
                joined the 65th Araw ng Maigo today, February 27, 2024, at the Maigo Covered Court, Poblacion, Maigo,
                Lanao del Norte.
            </div>
            <!--<div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
