<html lang="en"><head>
  <title>Municipality Profile</title>
  <link rel="stylesheet" type="text/css" href="https://www.iligan.gov.ph/css/knowiligan/cityprofile.css?1420916513">
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <!-- <link rel="stylesheet" href="css/bootstrap.min.css"> -->
  <script src="https://www.iligan.gov.ph/js/bootstrap.min.js?1559429953"></script>
  <!-- <link rel="stylesheet" href="css/main.css"> -->
  <link rel="stylesheet" type="text/css" href="https://www.iligan.gov.ph/css/main.css?789573303">
...
<div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Municipality Profile</h1>
                    <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Know Maigo</a></li>
                        <li class="breadcrumb-item active text-primary">Municipality Profile</li>
                    </ol>
            </div>
        </div>
        <!-- Header End -->
    ...
    <div class="container mt-4">
        <div class="row row-content row-width">
          <div class="col-md-3 col-for-side-nav">
            <div class="fixed-sidebar">
              ...
              <li><a href="http://localhost/maigowebsite/municipalmayor.php" class="px-2 text-dark averta-regular ">The Municipality Mayor</a></li>
                <li><a href="http://localhost/maigowebsite/municipalityprofile.php" class="px-2 text-dark averta-regular active-side-nav">The Municipality Profile</a></li>
          ...
          <div class="col-md-9 col-content">
            <div class="row">
              <div class="col">
              <BR><BR> <p class="averta-regular">Maigo, officially the Municipality of Maigo (Cebuano: Lungsod sa Maigo; Maranao: Inged a Maigo; Tagalog: Bayan ng Maigo), is a 4th class municipality in the province of Lanao del Norte, Philippines. According to the 2020 census, it has a population of 23,337 people.
 </p>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col">
                <table>
                  ...
                  <tr>
                    <td>Land Area</td>
                    <td>121.45 km2 (46.89 sq mi)</td>
                  </tr>
                  <tr>
                    <td>Climate Type</td>
                    <td>Short dry season (for one to three months). Rainfall is evenly distributed throughout the year.</td>
                  </tr>
                  <tr>
                    <td>Soil Type</td>
                    <td>Alluvial soil, fertile, good for farming.</td>
                  </tr>
                  <tr>
                    <td>Population</td>
                    <td> 23,337 (2020 Census)</td>
                  </tr>
                  <tr>
                    <td>Average Growth Rate</td>
                    <td>approximately 5% per year</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>Maranao, Cebuano, Binukid, Tagalog</td>
                  </tr>
                  <tr>
                    <td>Cultural Minority</td>
                    <td>Higaonons, Maranao, Kolibugan</td>
                  </tr>
                  <tr>
                    <td>Municipality Classification</td>
