...
-->
    ...
    <div class="container py-5">
        <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <h3 class="display-3 mb-4">News </h3>
                    <p class="mb-0">Read the latest news!</p>
        </div>
...
$query = "SELECT * FROM news WHERE title LIKE '%$searchTerm%' AND is_archived = 0 ORDER BY date DESC"; // Fetch only 6 items
$result = $con->query($query);
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-md-6 text-center text-md-start mb-md-0">
                    <CENTER> <span class="text-white"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Maigo
                                Official Website</a>, All right reserved.</CENTER></span>
                </div>
...
document.getElementById("search-input").addEventListener("keyup", function(news) {
...
document.getElementById("search-button").addEventListener("click", function(news) {
liveSearch();
}); 
