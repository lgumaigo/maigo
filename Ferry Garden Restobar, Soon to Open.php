...
-->
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="img/upcoming4.jpg" class="img-fluid w-100" alt="Image">
     ...
     Services End -->
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                <h2 class="averta-extrabold">Ferry Garden Restobar, Soon to Open

                </h2>
                <i class="fa fa-calendar"> <span class="averta-regular"> DATE :April 01, 2024</span></i><br>
                <i class="fa fa-user"> <span class="averta-regular"> Author • Municipality of Maigo</span> </i><br><br>
                Ferry Garden Restobar, soon to open! FYI we now accept venue reservation! With ample parking and options
                for indoor or outdoor receptions, your perfect wedding is within reach. Conveniently located along the
                highway.
                <!--<div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
