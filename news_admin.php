...
if(isset($_POST['submit'])){
    ...
    move_uploaded_file($image_tmp, "uploads/$image_sub");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO news (title, date, author, text) VALUES ('$title', '$date', '$author', '$text')";
...
<div class="container">
    ...
    <center>    <input type="submit" name="submit" value="Submit News"> </center><br>
    </form>
</div>
