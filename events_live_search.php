            ...
            <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s"><br><br><br><br>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="events_details.php?id=<?php echo urlencode($row['id']); ?>" class="btn btn-primary">Read More</a>
                    </div> 
                </div> 
            </div><br><br>
<?php
...
document.getElementById("search-input").addEventListener("input", function(event) {
    var searchQuery = event.target.value.trim(); // Get the trimmed value of the search input
...
document.getElementById("search-input").addEventListener("keypress", liveSearch);
document.getElementById("search-input").addEventListener("blur", liveSearch); 
