...
-->
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="img/upcoming1.jpg" class="img-fluid w-100" alt="Image">
     ...
     Services End -->
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                <h2 class="averta-extrabold">Poblacion Child Development Center is now accepting early registration.

                </h2>
                <i class="fa fa-calendar"> <span class="averta-regular"> DATE :March 27, 2024</span></i><br>
                <i class="fa fa-user"> <span class="averta-regular"> Author • Municipality of Maigo</span> </i><br><br>
                POBLACION CHILD DEVELOPMENT CENTER of Brgy Poblacion, Maigo Lanao del Norte is now accepting early
                registration for children ages 3-4 years old for this School Year 2024-2025
            </div>
            <!--<div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
