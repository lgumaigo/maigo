...
<html lang="en"><script async="false" type="text/javascript" src="chrome-extension://fnjhmkhhmkbjkkabndcnnogagogbneec/in-page.js"></script><head>
  <title> Council</title>
  <link rel="stylesheet" type="text/css" href="https://www.iligan.gov.ph/css/knowiligan/18thcouncil.css?1964782282">
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <!-- <link rel="stylesheet" href="css/bootstrap.min.css"> -->
  <script src="https://www.iligan.gov.ph/js/bootstrap.min.js?1662098830"></script>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
  <!-- Google tag (gtag.js) -->
<script async="" src="https://www.googletagmanager.com/gtag/js?id=G-Z6MF4GP4EX"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-Z6MF4GP4EX');
</script></head><body class="main-body">
    ...
    setInterval(updateClock, 1000);
        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <img src="img/images.jpeg" height="60" loading="lazy" id="maigo-governmentlogo">
...
<div class="container text-center py-5" style="max-width: 900px; margin: 0 auto; display: flex; justify-content: center; align-items: center;">
    <div>
        <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Council</h3>
        <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Know Maigo</a></li>
            <li class="breadcrumb-item active text-primary">Municipal Mayor</li>
        </ol>
    </div>
</div>
...
<!-- Header End -->
        ...
        <!-- Add content for Sangguniang Bayan Members here -->
        ...
        <div class="col-md-3 col-for-side-nav">
            <div class="fixed-sidebar">
                <ul class="col-12 col-lg-auto pages-side-nav-ul">
                    ...
                    <li><a href="http://localhost/maigowebsite/council.php" class="px-2 text-dark averta-regular active-side-nav">  Council</a></li>
                    <li><a href="http://localhost/maigowebsite/missionvision.php" class="px-2 text-dark averta-regular">Mission &amp; Vision</a></li>
                    <li><a href="http://localhost/maigowebsite/map.php" class="px-2 text-dark averta-regular">Maps</a></li>
...
<<div class="container py-9">
    <div class="row align-items-center">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="about-experience bg-secondary rounded text-center p-4">
                        <h1 class="display-1 mb-0 text-white">11</h1>
                        <small class="fs-5 fw-bold text-white">Years Experience</small>
                    </div>
                </div>
                <div class="col-md-6"> <!-- Changed col-md-18 to col-md-6 -->
                    <div class="row g-3">
                        <div class="col-md-12">
                            <img class="img-fluid rounded w-100" src="img/mayor.jpg" alt="Mayor Image">
                        </div>
                        <div class="col-md-12">
                            <img class="img-fluid rounded w-100" src="img/mayorpaeng.jpg" alt="Mayor Paeng Image">
                        </div>
                        <div class="col-md-12">
                            <img class="img-fluid rounded w-100" src="img/dimaporo.jpg" alt="Dimaporo Image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="p-4">
                <h4 class="section-title bg-white text-start text-primary mb-4">Maigo Municipal Mayor Profile</h4>
                <h1 class="mb-4">Rafael "Paeng" Rizalda</h1>
                <p class="mb-4">Rafael Rizalda Cailing, a devoted public servant, is widely regarded as a beacon of integrity and compassion in his municipality. With a genuine commitment to improving the lives of his constituents, he tirelessly works to address their needs and concerns. Known for his approachability and willingness to listen, Rafael fosters open communication and collaboration within the community.</p>
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="feature-box text-center p-4 bg-light rounded">
                            <img class="img-fluid mb-3" src="img/dedication.png" alt="Dedication Icon">
                            <h5 class="mb-3">Dedicated Services</h5>
                            <p>His leadership is characterized by transparency, fairness, and a strong sense of duty, earning him the respect and admiration of both colleagues and residents alike.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-box text-center p-4 bg-light rounded">
                            <img class="img-fluid mb-3" src="img/heart.jpg" alt="Heart Icon">
                            <h5 class="mb-3">A Good Father and a Husband</h5>
                            <p>As a husband and father, he leads by example, embodying the values of empathy, humility, and dedication to service.</p>
                        </div>
                    </div>
                </div>
            </div>
