    ...
    setInterval(updateClock, 1000);
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Mission and Vision</h1>
                    <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Know Maigo</a></li>
                        <li class="breadcrumb-item active text-primary">Mission and Vision</li>
                    </ol>
            </div>
        </div>
        <!-- Header End -->
          ...
          <div class="col-md-3 col-for-side-nav">
            <div class="fixed-sidebar">
              <ul class="col-12 col-lg-auto pages-side-nav-ul">
                ...
                <li><a href="http://localhost/maigowebsite/missionvision.php" class="px-2 text-dark averta-regular  active-side-nav">Mission &amp; Vision</a></li>
        ...
        <div class="container-fluid hero-header bg-light py-5 mb-5">
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h1 class="display-4 mb-3 animated slideInDown">Mission</h1>
                        <p class="text-primary fs-5 mb-4">Effective Governance, Quality Services, Ecosystem Protection
                        </p>

                        <h5 class="animated slideInDown" style="text-align: justify;line-height: 2;">Our government
                            commits to have an effective local governance and deliver comprehensively the quality
                            services to the constituents specially to the marginalized/ disadvantaged group and restore
                            and protect the vital ecosystem that enhance diversity of resource.</h5>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 animated fadeIn">
                        <img class="img-fluid animated pulse infinite" style="animation-duration: 3s;"
                            src="img/vision1.png" alt="">
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="h-100">
                            <h1 class="display-4 mb-3 animated slideInDown">Vision</h1>
                            <p class="text-primary fs-5 mb-4">A Place Where Resilience and Harmony Thrive</p>
                            <h5 style="text-align: justify; line-height: 2;">Maigo envisioned as a vibrant Agricultural
                                Center in Mindanao producing Traditional and Cash Crops where the people are self
                                relient, healthy, educated, God fearing, living in a peaceful, progressive and
                                ecologically balanced and disaster reselient environment and guided by a caring,
                                responsive, accountable leadership and transparent governance.</h5>
