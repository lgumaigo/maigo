...
.search{
position: relative;
box-shadow: 0 0 40px rgba(247, 245, 245, 0);
...
.search input:focus{
 ...
 box-shadow: none;
 border: 2px solid rgb(178, 179, 159);
            ...
            <div class="row gx-0 align-items-center" style="height: 45px;">
                ...
                <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <a href="https://twitter.com/maigomps" class="btn btn-light btn-square border rounded-circle nav-fill me-3"><i class="fab fa-twitter"></i></a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Tourists Destinations</a>
                            <div class="dropdown-menu m-0">
                                <a href="AFP.php" class="dropdown-item">A Foodie Paradise</a>
                                <a href="TEH.php" class="dropdown-item">The Explorer's Hub</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="AFP.php" class="dropdown-item">Fast Facts</a>
                            <a href="TEH.php" class="dropdown-item">Getting here</a>
                            <a href="AFP.php" class="dropdown-item">Gallery</a>
                            <a href="TEH.php" class="dropdown-item">Culture</a>
                            <a href="AFP.php" class="dropdown-item">History</a>
                    ...
                    <CENTER><div class="container">
                          ...
                          <div class="col-md-10">
                            ...
                            <div class="search">
                              ...
                              <input type="text" class="form-control" placeholder="Search for restaurants and beaches">
        ...
        <div class="container-fluid team py-5">
            <div class="container py-5">
                <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="sub-style">
                        <h4 class="sub-title px-3 mb-0">TOURISM</h4>
                    </div>
                    
                    <h1 class="display-3 mb-4">A Foodie Paradise</h1>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/kambinganlogo.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href="https://www.facebook.com/maigofoodhouseandkambingan"><i class="fab fa-facebook-f"></i></a>
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                              <h5><a href="MaigoFoodHouse.php"><FONT COLOR="black"> Maigo Foodhouse & Kambingan </FONT></h5></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/kape.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href="https://www.facebook.com/profile.php?id=100025628496571"><i class="fab fa-facebook-f"></i></a>
                                  <!--  <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-instagram"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-linkedin-in"></i></a>-->
                                </div>
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                                <h5><a href="Kape Barato.php"><FONT COLOR="black">Kape Barato</FONT></h5></a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/FOCC.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href="https://www.facebook.com/pages/FOC-Kitchen-Maigo-/189445501884113"><i class="fab fa-facebook-f"></i></a>
                                    <!--<a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-instagram"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-linkedin-in"></i></a>-->
                                </div>
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                              <br>  <h5><a href="FOC Kitchen Maigo.php"><FONT COLOR="black">FOC Kitchen Maigo </FONT></h5></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/CRISPY+KING.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href="https://www.facebook.com/profile.php?id=61556932425706"><i class="fab fa-facebook-f"></i></a>
                                 <!--  <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-instagram"></i></a>
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-linkedin-in"></i></a>-->
                                </div>
                            ...
                            <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                              <br>  <h5><a href="Crispy King.php"><FONT COLOR="black"> Crispy King</FONT></h5></a>
    ...
    <div class="container">
      <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <CENTER>   <span class="text-white"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Maigo Official Website</a>, All rightS reserved.</CENTER></span>
            </div> 
