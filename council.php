...
<div class="container text-center py-5" style="max-width: 900px; margin: 0 auto; display: flex; justify-content: center; align-items: center;">
    <div>
        ...
        <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            ...
            <li class="breadcrumb-item active text-primary">Council</li>
        </ol>
    </div>
</div>
...
<!-- Header End -->
    ...
    <div class="container py-5">
        <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="sub-style">
                <h4 class="sub-title px-3 mb-0">Sangguniang Bayan Members</h4>
            </div>
        </div>
      ...
      <div class="container mt-4">
        <div class="row row-content row-width">
          ...
          <div class="col-md-9 col-main-content mt-1">
            <div class="container">
              <div class="row">
                <div class="col-12">
                  <div class="row d-flex justify-content-center">
                    <div class="col-4 card-box col-card-box my-5 d-flex justify-content-center align-items-center">
                      <div class="profile-image">
                        <img src="img/sb1.jpg" loading="lazy" class="councilor-image">
                      </div>
                      <div class="content-  info">
                        <div class="designation">
                          <h5 class="averta-extrabold vicemayor-name">Lanto Mutia</h5>
                          <span class="averta-extrabold position">Vice Mayor</span>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <style>.profile-image img {
    border-radius: 50%;
              ...
              <div class="row">
                <div class="col-4 mt-4 col-card-box">
                  <div class="container card-box d-flex justify-content-center align-items-center">
                    <div class="profile-image">
                      <img src="img/sb2.jpg" loading="lazy" class="councilor-image">
                    </div>
                    <div class="content-info">
                      <div class="designation">
                        <h5 class="averta-extrabold councilor-name"> Julius Frago</h5>
                        <span class="averta-extrabold position">Councilor</span><br>
                      </div>
                    </div>
                  </div>
                  <style>.profile-image img {
    border-radius: 50%;
                ...
                <div class="col-4 mt-4 col-card-box">
                  <div class="container card-box d-flex justify-content-center align-items-center">
                    <div class="profile-image">
                      <img src="img/sb3.jpg" loading="lazy" class="councilor-image">
                    </div>
                    <div class="content-info">
                      <div class="designation">
                        <h5 class="averta-extrabold councilor-name">Mama Orong</h5>
                        <span class="averta-extrabold position">Councilor </span><br>
                      </div>
                    </div>
                  </div>
    ...
    border-radius: 50%;
                ...
                <div class="col-4 mt-4 col-card-box">
                  <div class="container card-box d-flex justify-content-center align-items-center">
                    <div class="profile-image">
                      <img src="img/sb4.jpg" loading="lazy" class="councilor-image">
                    </div>
                    <div class="content-info">
                      <div class="designation">
                        <h5 class="averta-extrabold councilor-name">Boboy Bongcawil</h5>
                        <span class="averta-extrabold position">Councilor</span><br>
                      </div>
                    </div>
                  </div>
    ...
    border-radius: 50%;
                ...
                <div class="col-4 mt-4 col-card-box">
                  <div class="container card-box d-flex justify-content-center align-items-center">
                    <div class="profile-image">
                      <img src="img/sb5.jpg" loading="lazy" class="councilor-image">
                    </div>
                    <div class="content-info">
                      <div class="designation">
                        <h5 class="averta-extrabold councilor-name">Molong Santos</h5>
                        <span class="averta-extrabold position">Councilor </span><br>
                      </div>
                    </div>
                  </div>
    ...
    border-radius: 50%;
                ...
                <div class="col-4 mt-4 col-card-box">
                  <div class="container card-box d-flex justify-content-center align-items-center">
                    <div class="profile-image">
                      <img src="img/sb6.jpg" loading="lazy" class="councilor-image">
                    </div>
                    <div class="content-info">
                      <div class="designation">
                        <h5 class="averta-extrabold councilor-name">  Tessie Salac</h5>
                        <span class="averta-extrabold position">Councilor</span><br>
                      </div>
                    </div>
                  </div>
    ...
    border-radius: 50%;
                ...
                <div class="col-4 mt-4 col-card-box">
                  <div class="container card-box d-flex justify-content-center align-items-center">
                    <div class="profile-image">
                      <img src="img/sb9.jpg" loading="lazy" class="councilor-image">
                    </div>
                    <div class="content-info">
                      <div class="designation">
                        <h5 class="averta-extrabold councilor-name">Cocoy Villalon</h5>
                        <span class="averta-extrabold position">Councilor</span><br>
                      </div>
                    </div>
                  </div>
    ...
    border-radius: 50%;
                ...
                <div class="col-4 mt-4 col-card-box">
                  <div class="container card-box d-flex justify-content-center align-items-center">
                    <div class="profile-image">
                      <img src="img/sb8.jpg" loading="lazy" class="councilor-image">
                    </div>
                    <div class="content-info">
                      <div class="designation">
                        <h5 class="averta-extrabold councilor-name">Michael Biliran</h5>
                        <span class="averta-extrabold position">Councilor </span><br>
                      </div>
                    </div>
                  </div>
