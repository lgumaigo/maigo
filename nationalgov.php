...
<html lang="en">
    ...
    <head>
        ...
        <title> National Government Agencies/Offices</title>
    ...
    setInterval(updateClock, 1000);
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">National Government
                    Agencies/Offices</h1>
                    <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">For Residents</a></li>
                        <li class="breadcrumb-item active text-primary">National Government/Offices</li>
                    </ol>
            </div>
        </div>
        <!-- Header End -->
          ...
          <div class="col-md-3 col-for-side-nav">
            <div class="fixed-sidebar">
              <ul class="col-12 col-lg-auto pages-side-nav-ul">
                <li><a href="http://localhost/maigowebsite/nationalgov.php" class="px-2 text-dark averta-regular active-side-nav ">National Government Agencies/Offices</a></li>
                ...
                <center>
                    <div class="feature-icon mb-4">
                        <div class="p-3 d-inline-flex bg-white rounded">
                            <a href="https://www.facebook.com/profile.php?id=100063951466419">
                                <img src="img/tesda.png" alt="" width="150px" height="150px">
                            </a>
                        </div>
                    </div>
                </center>
                <div class="feature-content d-flex flex-column">
                    <h5 class="mb-4" style="text-align: justify;">Technical Education and Skills Development Authority</h5>
                    <p class="mb-0">Labuay, Maigo Lanao del Norte</p><br> <br><br> 
                    <i class="fa fa-phone"> <span class="averta-regular">09051702957</span></i>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                        ...
                                        <a href="https://www.facebook.com/maigo.lanao.7">    <img src="img/mps.jpg" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">Maigo MPS Municipal Community Affairs</h5><br>
                                    <p class="mb-0">Poblacion,Maigo Lanao del Norte</p><br><br><br>
                                    <i class="fa fa-phone"> <span class="averta-regular">227-4367 </span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                        ...
                                        <a href="https://www.facebook.com/pages/Maigo-Police-StationLanao-del-Norte/174924573330882">    <img src="img/PNP.png" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">Maigo Municipal Police Station</h5><br>
                                    <p class="mb-0">Poblacion,Maigo Lanao del Norte</p><br>
                                    <i class="fa fa-phone"> <span class="averta-regular">09985986880 </span></i><br>
                                    <i class="fa fa-phone"> <span class="averta-regular">09176278361 </span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                        ...
                                        <a href="https://www.facebook.com/profile.php?id=100076074908211">    <img src="img/bfpp.png" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">The Bureau of Fire Protection</h5><br>
                                    <p class="mb-0">Poblacion,Maigo Lanao del Norte<br><br></p>
                                    <i class="fa fa-phone"> <span class="averta-regular">09468995310 </span></i><br>
                                    <i class="fa fa-phone"> <span class="averta-regular">09663824132 </span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                      ...
                                      <a href="https://www.facebook.com/profile.php?id=100064786596030">      <img src="img/mswdo.png" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">Municipal Social Welfare and Development
                                        Office (MSWDO)</h5>
                                    <p class="mb-0">Poblacion,Maigo Lanao del Norte</p><BR><br>
                                    <i class="fa fa-phone"> <span class="averta-regular">221-5915</span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                       ...
                                       <a href="https://www.facebook.com/maigo.lanao.7">     <img src="img/coastg.png" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">Coast Guard Maigo</h5>
                                    <p class="mb-0"><br><br>Poblacion,Maigo Lanao del Norte</p><br><br>
                                    <i class="fa fa-phone"> <span class="averta-regular">09176543437 </span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                       ...
                                       <a href="https://www.facebook.com/profile.php?id=100089043738619">     <img src="img/mdrrmo.jpg" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">Municipal Disaster Risk Reduction and
                                        Management Office</h5>
                                    <p class="mb-0">Poblacion,Maigo Lanao del Norte</p><br><br>
                                    <i class="fa fa-phone"> <span class="averta-regular">09264901314 </span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                        ...
                                        <a href="https://www.facebook.com/groups/1062131627284304">    <img src="img/ruralh.jpg" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">Rural Health Unit</h5>
                                    <p class="mb-0"><br>Poblacion,Maigo Lanao del Norte</p><BR>
                                    <i class="fa fa-phone"> <span class="averta-regular">09770910665</span></i><BR>
                                    <i class="fa fa-phone"> <span class="averta-regular">227-4236</span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                        ...
                                        <a href="https://www.facebook.com/mcesw">    <img src="img/deped.png" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">DepEd - Maigo </h5>
                                    <p class="mb-0"><br>Poblacion,Maigo Lanao del Norte</p><BR><br><br> 
                                    <i class="fa fa-phone"> <span class="averta-regular">(063) 227 4986</span></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    <div class="feature-icon mb-4">
                                        ...
                                        <a href="https://www.facebook.com/profile.php?id=61554034227358">    <img src="img/dilg.jpg" alt="" width="150px" height="150px"> </a>
                                        </div>
                                    </div>
                                </center>
                                <div class="feature-content d-flex flex-column">

                                    <h5 class="mb-4" ;text-align="justify">Department of the Interior and Local Government - Maigo</h5><br>
                                    <p class="mb-0"><br>Poblacion,Maigo Lanao del Norte</p><BR>
                                </div>
                            </div>
                        </div>
