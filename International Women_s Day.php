...
-->
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="img/ucpcoming6.jpg" class="img-fluid w-100" alt="Image">
     ...
     Services End -->
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                <h2 class="averta-extrabold">International Women's Day

                </h2>
                <i class="fa fa-calendar"> <span class="averta-regular"> DATE :March 26, 2024</span></i><br>
                <i class="fa fa-user"> <span class="averta-regular"> Author • Municipality of Maigo</span> </i><br><br>
                National Women's Day is a significant occasion dedicated to honoring the social, economic, cultural, and
                political achievements of women worldwide, while also advocating for gender equality and women's rights
