    ...
    setInterval(updateClock, 1000);
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="http://localhost/HOMIE/HOM.php" class="nav-item nav-link ">For Visitors</a>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Building Permit</h1>
                    <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <!--  <li class="breadcrumb-item"><a href="#">Pages</a></li>-->
                        <li class="breadcrumb-item active text-primary">Building Permit</li>
                    </ol>
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-img pb-5 ps-5">
                            <img src="img/permit.png" class="img-fluid rounded w-100" style="object-fit: cover;"
                                alt="Image">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <h4 class="sub-title pe-3 mb-0">Application for Building Permit</h4>
                            <h1 class="display-3 mb-4">Requirements</h1>
                            <p style="text-align: justify; text-indent: 0px; color:black">Monday 9:00 A.M -5:00 P.M.
                                (Flag Raising from 8:00 A.M. -9:00A.M.) Tuesday to Friday, 8:30 A.M. to 5:00 P.M.
                                (Morning Prayer 8:00 to 8:30 A.M.) No noon break<br>
                                <strong> Who may Avail of the Service : </strong> <br><br> Building Permit
                                Applicants<br><br>
                                1. 2 copies of Lot Plan with certification from a Geodetic Engineer that the proposed
                                building will not encroach the adjoining properties<br>
                                2. 7 sets of Building Plans (Structural, Electrical, Plumbing) with Site Development
                                Plan indicating the set-back/yard distances at the front sides and with Perspective at
                                page 1 of every set<br>
                                3. 4 copies of Bill of Materials and Cost Estimates<br>
                                4. 4 copies of Specification documents<br>
                                5. 4 copies of Title of Property (Transfer Certificate of Title), certified true
                                copy<br>
                                6. 4 copies of Deed of Absolute Sale/Lease Contract/Contact to Sell<br>
                                7. Consent and Authority from the owner if the TCT is not in the name of the
                                applicant<br>
                                8. 4 copies of latest Tax declaration (Please refer to City Assessor’s Office for the
                                issuance of the Certification)<br>
                                9. 4 copies of current Tax receipt of Real Property Tax payment<br>
                                10.1 copy of Construction log Book<br>
                                11.2 copies of Structural Design Computation w/ Seismic Analysis which conforms to the
                                latest NSCP-for 2 storeys and above or 1 storey w/ attic/mezzanine/roof
                                deck/penthouse<br>
                                12.2 copies of Plate Load Test Analysis-for 3 storeys or 2 storeys w/
                                attic/mezzanine/roof deck/penthouse<br>
                                13.2 copies of Environment Compliance Certificate/Environment and<br>
                                14.Natural Resources (ENRO) Clearance-for communication towers and gas depot<br>
                                15.1 copy of Department of Labor and Employment (DOLE) Clearance for Industrial
                                Buildings<br>
                                16.Duly filled-out and Notarized Building permit Application Forms (and Ancillary Permit
                                Forms: Electrical, Mechanical, Plumbing, Fencing).<br><br>
                            </p>
                            <strong> BOX A Fees </strong><br>
                            Area of Building = 83 sq. m.<br>
                            Line and Grade - P 470.00<br>
                            Building - P 671.00<br>
                            Plumbing - P 112.00<br>
                            Electrical - P 280.00<br>
                            Fence - P 132.00<br>
                            <!--      <div class="mb-4">
