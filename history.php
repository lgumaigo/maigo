    ...
    setInterval(updateClock, 1000);
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">History</h1>
    ...
    <div class="row row-content row-width">
        ...
        <div class="col-md-3 col-for-side-nav">
            <div class="fixed-sidebar">
                ...
                <li><a href="http://localhost/maigowebsite/history.php" class="px-2 text-dark averta-regular  active-side-nav">History</a></li>
        ...
        <div class="col-md-9 d-flex justify-content-center">
            <img class="img-fluid rounded" src="img/adminlogo.jpg" alt="">
        </div>
    </div>
</div>
...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <style>
    .img-fluid {
        width: 200%; /* Ensures the image fills its container */
        height: 300px; /* Set a fixed height for both images */
    }
</style>
            <div class="row">
                <div class="col-md-10 mb-4">
                    <img class="img-fluid rounded" src="img/mago.jpg" alt="">
                </div>
                <div class="col-md-10 mb-4">
                    <img class="img-fluid rounded" src="img/mapa.png" alt="">
                </div>
            </div>
        </div>
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="h-100">
                <h1 class="display-8 mb-3">"Journey Through Time: Exploring Maigo's Rich History"</h1>
                <p class="text-primary fs-5 mb-4">"A Glimpse into Maigo's Past"</p>
                <p class="mb-4" style="text-align: justify;">
                    The town of Maigo has a rich and diverse history that dates back many years. Originally part of Kolambugan, it became a separate municipality in 1959 through Executive Order No. 331. Maigo's formation included territories from Kolambugan and Bacolod, contributing to its unique cultural blend.
                </p>
                <p class="mb-4" style="text-align: justify;">
                    Over the years, Maigo has been a place of harmony between Muslims and Christians. However, it has also faced challenges, including conflicts with the Moro Islamic Liberation Front. Despite these challenges, the spirit of unity and resilience among Maigo's residents remains strong.
                </p>
                <p class="mb-4" style="text-align: justify;">
                    The majority of Maigo's population has roots in the Maranao community. Stories of migration and cultural exchange add layers to the town's history, reflecting its dynamic past.
                </p>
                <a class="btn btn-primary py-3 px-4" href="https://en.wikipedia.org/wiki/Maigo#History">Read More</a>
            </div>
        </div>
    </div>
</div></div>
